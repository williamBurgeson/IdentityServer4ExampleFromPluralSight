...
namespace AngularStsWebApp.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        [Route("{returnUrl}")]
        [HttpGet]
        public async Task<LoginModel> GetLoginModel(string returnUrl)
        {
            // build a model so we know what to show on the login page
            var model = await BuildLoginModelAsync(returnUrl);
        ...
        {
            model.RedirectToUrl = null;
            if (model.CancelLogin)
            {
                ...
                if (context != null)
                {
                    ...
                    model.RedirectToUrl = model.ReturnUrl;
                    return model;
                }
                else
                {
                    ...
                    // WB: not 100% sure what to do in this case at the moment...
                    model.RedirectToUrl = "/";
                    return model;
                }
            }
        ...
        //{
        //    var model = await BuildLoginModelAsync(model.ReturnUrl);
        //    model.Username = model.Username;
        //    model.RememberLogin = model.RememberLogin;
        //    return model;
        //}
